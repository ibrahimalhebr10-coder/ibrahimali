        ...
        {!selectedInvestmentFarm && (
          <>
            <div className="flex-1 flex flex-col overflow-hidden">
              <div className="flex-shrink-0 bg-white/95 backdrop-blur-md z-20 shadow-sm pt-16 pb-2">
              ...
              <div className="flex-1 overflow-y-auto lg:pb-4" style={{ paddingBottom: '12rem' }}>
                <div className="max-w-7xl mx-auto">
