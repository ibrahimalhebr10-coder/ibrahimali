    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">إدارة الصيانة ورسوم الصيانة للمزارع</p>
        </div>
        {!selectedRecord && (
          <button
      ...
      {showAddForm && !selectedRecord && (
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-6">إنشاء سجل صيانة جديد</h3>
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            {activeTab === 'stages' && (
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-4">
                  <h4 className="font-semibold text-gray-900 mb-4">إضافة مرحلة جديدة</h4>
                    ...
                    <div key={stage.id} className="bg-white border border-gray-200 rounded-xl p-4">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <h5 className="font-semibold text-gray-900">{stage.stage_title}</h5>
                          {stage.stage_note && (
            ...
            {activeTab === 'media' && (
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-4">
                  <h4 className="font-semibold text-gray-900 mb-4">رفع ملفات جديدة</h4>
                  <div className="flex gap-3">
                    <input
                      type="file"
                      accept="image/*"
            ...
            {activeTab === 'fees' && (
              <div className="space-y-4">
                <div className="bg-gray-50 rounded-xl p-6">
                  <h4 className="font-semibold text-gray-900 mb-4">رسوم الصيانة</h4>
