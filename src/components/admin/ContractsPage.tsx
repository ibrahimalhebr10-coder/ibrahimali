  ...
  return (
    <div>
      ...
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">العقود</h1>
        <p className="text-sm md:text-base text-gray-600">عرض ومتابعة العقود الاستثمارية</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-3 md:p-4 mb-6">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pr-10 md:pr-12 pl-4 py-2 md:py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-darkgreen text-right text-sm md:text-base"
          />
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:p-12">
        <div className="text-center max-w-md mx-auto">
          ...
          <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2">لا توجد عقود محملة</h3>
          <p className="text-sm md:text-base text-gray-600 mb-6">
            هذه الصفحة مخصصة لعرض ومتابعة العقود الاستثمارية فقط.
          </p>
          <div className="bg-amber-50 rounded-lg p-4 text-right">
            <p className="text-xs md:text-sm text-amber-900 font-medium mb-2">ملاحظة:</p>
