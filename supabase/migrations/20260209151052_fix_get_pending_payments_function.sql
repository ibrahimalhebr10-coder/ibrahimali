/*
  # إصلاح دالة get_pending_payments
  
  تحديث الدالة لاستخدام أسماء الأعمدة الصحيحة من جدول reservations
*/
...
BEGIN
  ...
  SELECT 
    ...
    '' as customer_email, -- البريد غير موجود في user_profiles
    r.path_type,
    r.farm_name, -- استخدام farm_name من reservations مباشرة
    r.total_trees as trees_count, -- الاسم الصحيح
    r.total_price as total_amount, -- الاسم الصحيح
    r.created_at,
    r.payment_deadline,
