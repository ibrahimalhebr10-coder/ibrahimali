/*
  # Fix Client Maintenance Complete Details

  1. Problem
    - get_client_maintenance_records uses wrong column name (tree_count instead of total_trees)
    - This causes the function to fail when retrieving client tree counts

  2. Solution
    - Update function to use correct column name (total_trees)
    - Ensure all maintenance details are properly returned
*/
