/*
  # تصحيح دالة المسار الزراعي
  
  ## المشكلة
  المسار الزراعي: العميل يملك أشجار من خلال reservations.tree_count
  ليس من خلال agricultural_tree_inventory (جدول إداري فقط)
  
  ## التصحيح
  - الجلب من reservations مباشرة
  - حساب نصيب العميل: reservations.tree_count × cost_per_tree
*/
...
COMMENT ON FUNCTION get_agricultural_client_maintenance_records IS 'جلب صيانات المزارع الزراعية للعميل (المسار الزراعي) - من reservations';
